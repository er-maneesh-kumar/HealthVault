...
function Signup() {
  ...
  const roleMap = { citizen: 'patient', doctor: 'doctor', hospital: 'hospital' };

  const getRedirectPath = (backendRole) => {
    switch (backendRole) {
      case 'patient':  return '/create-patient';
  ...
  const handleSignupWithEmail = async (e) => {
    ...
    try {
      ...
      // Sync AuthContext immediately before navigating
      refreshUser();
...
"
        ...
        <div className="loginContainer">
          ...
          <div className="social">
            ...
            />
            <h4 className='signUplink'>Already a user? <Link to="/login" className='Loginlink'>Login</Link> here.</h4>
          </div>
        </div>
      </div>
    </body>
