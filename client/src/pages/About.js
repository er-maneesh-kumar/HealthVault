...
const About = () => {
  const faqs = [
    {
      question: 'What is Health Vault?',
      answer: 'Health Vault is a Next Generation Health Vault designed to securely store and manage various types of medical information such as prescriptions, lab reports, X-rays, bills, and more. It ensures complete confidentiality and easy accessibility from any location.',
    },
    {
      question: 'Why Should use Health Vault?',
      answer: 'Maintaining your health records like prescriptions, lab test reports, immunization details, information about your allergies, medical images etc. Health Vault can help you in managing your health efficiently. Health Vault can help you in: Improving your awareness about your health. Having easy access to your health records. Sharing your health records with your doctors, family and friends. Printing your all or selected health records.',
    },
    {
      question: 'How Can Health Vault help in Improving my quality of Healthcare?',
      answer: 'Health Vault can help you to manage health and wellness information. This information include lab results, prescriptions, medications, medical images, vitals etc. Managing these at one central place (accessible from anywhere anytime).',
    },
    {
      question: 'How will Health Vault saves your time and Money?',
    ...
    {
      question: 'Do I have to pay to use Health Vault?',
      answer: 'No, Health Vault web Service are free of cost for all.',
    },
    {
      question: 'Is My Health Information in Health Vault safe and secure?',
      answer: 'Yes, your health information in Health Vault is absolutely safe and secure. Only you have access to it.',
    },
    {
      question: 'How Many Documents/Reports/Medical Images can I store in my profile at Health Vault?',
      answer: 'There is no limit on the number of documents / reports / medical images that can be stored in my profile at Health Vault.',
    },
    {
      question: 'For How Long Would My Health Information remain stored in Health Vault?',
      answer: 'Your health information would remain stored in Health Vault for life time, from the date of upload.',
    },
  ...
  return (
    <div className="mainAboutContainer">
      <div className="section">
        ...
        <p>
          HealthVault is a unique platform where you can store and manage comprehensive medical data, ensuring privacy and accessibility. Our mission is to provide a seamless experience for managing your health information.
        </p>
        <h2>Key Features:</h2>
      ...
      <div className="section">
        ...
        <div className="support-content">
          ...
          <p><strong>Email:</strong> [testing@healthvault.co.in]</p>
          <p><strong>Twitter:</strong> HealthVault.Health</p>
          <p><strong>Instagram:</strong> HealthVault.Health</p>
          <p><strong>Facebook:</strong> HealthVault.Health</p>
        </div>
      </div>
      <div className="section">
        <div className="main-bar"></div>
